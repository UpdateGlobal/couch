...
&lt;data&gt;
		...
		&lt;/widget&gt;
 		&lt;LoaderMax name="dynamicLoaderMax" load="true" prependURLs="https://www.greensock.com/"&gt;
...
&lt;VideoLoader url="video.flv" name="video1" description="Hidden dangers of steel wool" autoPlay="false"&gt;
	&lt;links&gt;
		&lt;link url="https://www.greensock.com" title="GreenSock" /&gt;
...
function completeHandler(event:LoaderEvent):void {
	...
	trace("first link url: " + xml.links[0].link[0].&#64;url); //traces "first link url: https://www.greensock.com"
}
</listing>
 * 
