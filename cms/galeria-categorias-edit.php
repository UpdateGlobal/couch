...
if($proceso=="Actualizar"){
  ...
  $orden            = $_POST['orden'];
  $estado           = $_POST['estado'];
  $actualizarCategoria = "UPDATE galerias_categorias SET cod_categoria='$cod_categoria', slug='$slug', categoria='$categoria', orden='$orden', estado='$estado' WHERE cod_categoria='$cod_categoria'";
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            ...
            <footer class="card-footer">
              ...
              <button class="btn btn-bold btn-primary" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-refresh"></i> Publicar Categor&iacute;a</button>
