...
if($proceso == "Registrar"){
  ...
  $insertarCategoria = "INSERT INTO noticias_categorias(categoria, slug, orden, estado)VALUE('$categoria', '$slug', '$orden', '$estado')";
  $resultadoInsertar = mysqli_query($enlaces,$insertarCategoria);
  $mensaje = "<div class='alert alert-success' role='alert'>
          <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
          <strong>Nota:</strong> La categor&iacute;a se registr&oacute; con exitosamente. <a href='noticias-categorias.php'>Ir a categorias</a>
        </div>";
}
?>
<!DOCTYPE html>
<html lang="es">
  ...
  <body>
    ...
    <?php $menu="noticiascategorias"; include("module/menu.php"); ?>
