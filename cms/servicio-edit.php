          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <textarea data-toolbar="full" data-provide="summernote" id="descripcion" name="descripcion" data-min-height="150"><?php echo $descripcion; ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <textarea data-toolbar="full" data-provide="summernote" id="beneficios" name="beneficios" data-min-height="150"><?php echo $beneficios; ?></textarea>
                </div>
              </div>
