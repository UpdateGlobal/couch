        ...
        <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label" for="texto">Descripci&oacute;n:</label>
                </div>
                <div class="col-8 col-lg-10">
                  <textarea data-toolbar="full" data-provide="summernote" id="descripcion" name="descripcion" data-min-height="150"></textarea>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <textarea data-toolbar="full" data-provide="summernote" id="dirige" name="dirige" data-min-height="150"></textarea>
                </div>
              </div>

              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label" for="beneficios">Beneficios:</label>
                </div>
                <div class="col-8 col-lg-10">
                  <textarea data-toolbar="full" data-provide="summernote" id="beneficios" name="beneficios" data-min-height="150"></textarea>
                </div>
              </div>
