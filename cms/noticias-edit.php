...
if($proceso=="Actualizar"){
  ...
  $actualizarNoticias = "UPDATE noticias SET cod_noticia='$cod_noticia', cod_categoria='$cod_categoria', titulo='$titulo', slug='$slug', imagen='$imagen', noticia='$noticia', fecha='$fecha', autor='$autor', estado='$estado' WHERE cod_noticia='$cod_noticia'";
  ...
  <body>
    ...
    <main>
      ...
      <div class="main-content">
        <div class="card">
          <h4 class="card-title"><strong>Editar Noticia</strong></h4>
