        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label" for="contenido_1">Enlace:</label>
                </div>
                <div class="col-8 col-lg-10">
              ...
              <div class="row">
                <div class="col-4 col-lg-2">
                  <label>Imagen:</label><br><span>(2000px x 844px)</span>
                </div>
              ...
              <div class="row">
                <div class="col-4 col-lg-2">
                  <label>Imagen:<br><span>(2000px x 844px)</span></label>
                </div>
                <div class="col-4 col-lg-8">
                  <?php if($xVisitante=="1"){ ?><p><?php echo $img_contenido; ?></p><?php } ?>
                  <input class="form-control" name="img_contenido" type="<?php if($xVisitante=="1"){ ?>hidden<?php }else{ ?>text<?php } ?>" id="img_contenido" value="<?php echo $img_contenido; ?>" />
                </div>
                <div class="col-4 col-lg-2">
                  <?php if($xVisitante=="0"){ ?>
                  <button class="btn btn-info" type="button" name="boton4" onClick="javascript:Imagen('NOS');"><i class="fa fa-save"></i> Examinar</button>
