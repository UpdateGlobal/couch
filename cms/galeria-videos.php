        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-bordered">
              ...
              <h4 class="card-title"><strong>Lista de Videos</strong></h4>
              <div class="card-body">
                <a class="btn btn-info" href="<?php if($xVisitante=="0"){ ?>galeria-videos-nuevo.php<?php }else{ ?>javascript:visitante();<?php } ?>"><i class="fa fa-plus"></i> A&ntilde;adir nuevo</a>
                <hr>
                <form name="fcms" method="post" action="">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td><img class="d-block b-1 border-light hover-shadow-2 p-1" src="assets/img/videos/<?php echo $xImagen; ?>" /></td>
                        ...
                        <td>
                          <a class="boton-eliminar <?php if($xVisitante=="1"){ ?>boton-eliminar-bloqueado<?php } ?>" href="<?php if($xVisitante=="0"){ ?>galeria-videos-delete.php?cod_video=<?php echo $xCodigo; ?><?php }else{ ?>javascript:visitante();<?php } ?>">
                            <i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                        <td><a class="boton-editar" href="galeria-videos-edit.php?cod_video=<?php echo $xCodigo; ?>"><i class="fa fa-pencil-square" aria-hidden="true"></i></a></td>
                        <td>
                          <?php if($xVisitante=="0"){ ?>
                          <div class="hidden">
