			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 offset-md-4"><br>
						<ul class="breadcrumb">
						  <li><a href="index.php"><i class="fas fa-home"></i> Sobre Mi</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div id="fh5co-programs-section" style="background-color: #f9f9f9;">
			<div class="container">
				...
				<div class="row">
						    ...
						    <div class="panel-heading" role="tab" id="headingOne">
						      <h4 class="panel-title">
						        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
						          <i class="fas fa-book"></i>  Estudio Realizado <i class="fas fa-arrow-circle-left" style="float: right;"></i>
						        </a>
						      </h4>
						    </div>
					...
					<div class="col-md-6 col-sm-12" style="border-left: 2px solid;">
						    ...
						    <div class="panel-heading" role="tab" id="headingOne">
						      <h4 class="panel-title">
						        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1">
						          <i class="fas fa-user-plus"></i>  Experiencias Obtenidas <i class="fas fa-arrow-circle-left" style="float: right;"></i>
						        </a>
						      </h4>
						    </div>
